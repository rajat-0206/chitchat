...
def save_message(request):
        ...
        payload = {"app_id":"56f464d8-5f40-479c-b005-7bbc1dff146d","include_external_user_ids":[u_name2],"contents":{"en":"You have recieved a new message from "+naam},"headings":{"en":"Chitchat"},"url":"https://itschitchat.herokuapp.com/chating/"+c_id_in,"chrome_web_icon":"https://itschitchat.pythonanywhere.com/media/media/"+naam+".jpg","chrome_web_badge":"https://itschitchat.herokuapp.com/static/images/icon-192x192.png"}
        print(payload)
